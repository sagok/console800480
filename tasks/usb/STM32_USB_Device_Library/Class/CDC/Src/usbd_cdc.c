...
{
  USB_LEN_DEV_QUALIFIER_DESC,				// Size of this descriptor in bytes
  USB_DESC_TYPE_DEVICE_QUALIFIER,			// Device Qualifier descriptor type
  0x00,  0x02,								// USB version
  0x00,										// MASS STORAGE Class
  0x00,										// SCSI transparent command set
  0x00,										// BULK-ONLY TRANSPORT
